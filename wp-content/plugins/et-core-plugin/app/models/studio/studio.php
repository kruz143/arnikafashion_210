...
class Etheme_Studio {
	...
	public function enqueue_assets() {
		...
		wp_enqueue_script(
			'etheme-studio-isotope', ET_CORE_URL . 'app/models/studio/js/scripts.js', array(
			'jquery',
			'elementor-editor',
			//			'jquery-hover-intent',
		),
		...
		wp_enqueue_script(
			'etheme-studio-js', ET_CORE_URL . 'app/models/studio/js/isotope.js', array(
				'jquery',
				'elementor-editor',
	//			'jquery-hover-intent',
		...
		$localize_data = array(
			...
			'Btn' => array(
				...
				'Html' => '<div class="elementor-add-section-area-button elementor-add-et-button" title="xstore">
