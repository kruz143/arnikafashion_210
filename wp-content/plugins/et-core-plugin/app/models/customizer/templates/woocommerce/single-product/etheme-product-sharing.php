 ...
 */
	...
	// $element_options['product_sharing_target'] = Kirki::get_option( 'product_sharing_target_et-desktop' ) ? 'target="_blank"' : '';
	// $element_options['product_sharing_no_follow'] = Kirki::get_option( 'product_sharing_no_follow_et-desktop' ) ? 'rel="nofollow"' : '';
	$element_options['product_sharing_content_alignment'] = 'justify-content-' . Kirki::get_option( 'product_sharing_content_alignment_et-desktop' );
