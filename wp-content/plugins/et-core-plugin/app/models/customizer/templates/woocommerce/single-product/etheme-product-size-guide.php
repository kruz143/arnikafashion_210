...
$element_options['product_size_guide_type'] = Kirki::get_option('product_size_guide_type_et-desktop');

$element_options['product_size_guide_file'] = Kirki::get_option('product_size_guide_file_et-desktop');
