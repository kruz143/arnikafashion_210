...
<?php
	$data = json_decode( Kirki::get_option( 'header_mobile_main_elements' ), true );
	...
	$header_options['class'] = Kirki::get_option( 'main_header_sticky_et-mobile' ) ? 'sticky' : '';
...
<div class="header-main-wrapper <?php echo esc_attr($header_options['class']); ?>">
	<div class="header-main" data-title="<?php esc_html_e( 'Header main', 'xstore-core' ); ?>">
		<div class="et-row-container<?php echo !(Kirki::get_option( 'main_header_wide_et-mobile' )) ? ' et-container' : ''; ?>">
