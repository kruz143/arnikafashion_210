...
<?php
	$data = json_decode( Kirki::get_option( 'header_top_elements' ), true );
	...
	$header_options['class'] = Kirki::get_option( 'top_header_sticky_et-desktop' ) ? 'sticky' : '';
...
<div class="header-top-wrapper <?php echo esc_attr($header_options['class']); ?>">
	<div class="header-top" data-title="<?php esc_html_e( 'Header top', 'xstore-core' ); ?>">
		<div class="et-row-container<?php echo !(Kirki::get_option( 'top_header_wide_et-desktop' )) ? ' et-container' : ''; ?>">
