...
<?php
	$data = json_decode( Kirki::get_option( 'header_bottom_elements' ), true );
	...
	$header_options['class'] = Kirki::get_option( 'bottom_header_sticky_et-desktop' ) ? 'sticky' : '';
...
<div class="header-bottom-wrapper <?php echo esc_attr($header_options['class']); ?>">
	<div class="header-bottom" data-title="<?php esc_html_e( 'Header bottom', 'xstore-core' ); ?>">
		<div class="et-row-container<?php echo !(Kirki::get_option( 'bottom_header_wide_et-desktop' )) ? ' et-container' : ''; ?>">
