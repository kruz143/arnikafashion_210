...
<?php 
	...
	$element_options['menu_2_item_style_et-desktop'] = Kirki::get_option( 'menu_2_item_style_et-desktop' );
	$element_options['menu_2_alignment_et-desktop'] = Kirki::get_option( 'menu_2_alignment_et-desktop' );
