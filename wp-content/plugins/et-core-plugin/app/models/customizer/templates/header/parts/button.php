...
<?php 
	...
	$element_options['button_content_align_et-desktop'] = Kirki::get_option( 'button_content_align_et-desktop' );
	$element_options['button_content_align_et-mobile'] = Kirki::get_option( 'button_content_align_et-mobile' );
