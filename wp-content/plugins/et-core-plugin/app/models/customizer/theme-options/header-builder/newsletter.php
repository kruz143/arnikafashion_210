<?php  
	...
	// section newsletter
	Kirki::add_section( 'newsletter', array(
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'default'     => '#000000',
			'choices'     => array(
				'setting' => 'newsletter_background_et-desktop[background-color]',
