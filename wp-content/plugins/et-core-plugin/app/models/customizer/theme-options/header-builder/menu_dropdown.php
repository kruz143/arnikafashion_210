<?php  
	...
	Kirki::add_section( 'menu_dropdown', array(
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'output'      => array(
				array(
					'element' => '.et_b_header-menu.et_element-top-level .item-design-dropdown .nav-sublist-dropdown ul > li > a, .site-header .widget_nav_menu .menu > li > .sub-menu a, .site-header .etheme_widget_menu .item-design-dropdown .nav-sublist-dropdown ul > li > a',
				),
			),
		) );
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'default'     => '#000000',
			'choices'     => array(
				'setting' => 'menu_dropdown_background_custom_et-desktop',
