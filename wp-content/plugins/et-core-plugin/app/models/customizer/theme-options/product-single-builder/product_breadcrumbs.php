<?php  
	...
	Kirki::add_section( 'product_breadcrumbs', array(
				...
				'product_breadcrumbs_type_et-desktop' => array(
					...
					'render_callback' => function() {
				        $separator_type = array (
				            ...
				            'type2' => '<i class="et-icon et-right-arrow"></i>',
				            'type3' => '<i style="font-family: auto; font-size: 2em;">&nbsp;&#47;&nbsp;</i>',
				        );
				        return $separator_type[get_theme_mod('product_breadcrumbs_type_et-desktop')];
					}
				),
			),
		) );
		...
		if ( function_exists('vc_map') ) {
			...
			Kirki::add_field( 'et_kirki_options', array(
				...
				'default'     => 'default',
				'choices'     => array(
					'default' => esc_html__('Boxed', 'xstore-core'),
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'output'      => array(
				array(
					'element' => '.single-product .page-heading.vc_row, .single-product .page-heading:not(.vc_row) .page-heading-inner',
				),
			),
		) );
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'default'     => '#000000',
			'choices'     => array(
				'setting' => 'product_breadcrumbs_background_et-desktop[background-color]',
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'transport' => 'postMessage',
	        'js_vars'   => box_model_output('.single-product .page-heading.vc_row, .single-product .page-heading:not(.vc_row) .page-heading-inner')
		) );
