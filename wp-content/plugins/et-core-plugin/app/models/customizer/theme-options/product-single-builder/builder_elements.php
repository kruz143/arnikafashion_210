<?php 
	...
	Kirki::add_section( 'single_product_builder_elements', array(
	    'title'          => false,
		...
		Kirki::add_field( 'et_kirki_options', array (
			...
			// 'label'    => esc_html__( 'product single elements', 'xstore-core' ),
		...
		Kirki::add_field( 'et_kirki_options', array (
			...
			// 'label'    => esc_html__( 'product archive elements', 'xstore-core' ),
			'label' => false, // to prevent searching
			'section'  => 'single_product_builder_elements',
			'default'  => ''
		) );
		...
		Kirki::add_field( 'et_kirki_options', array(
			'type'        => 'repeater',
			// 'label'       => esc_html__( 'connect block product single package', 'xstore-core' ),
			'label' => false, // to prevent searching
			'section'     => 'single_product_builder_elements',
			'priority'    => 10,
			'row_label' => array(
