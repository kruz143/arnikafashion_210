...
$columns = json_decode( Kirki::get_option( 'product_archive_elements' ), true );

if ( ! is_array( $columns ) ) {
    $columns = array();
}

$blocks = Kirki::get_option( 'connect_block_product_archive_package' );
...
<div class="et_customizer-builder et_customizer-builder-archive_product hidden" data-option="product_archive_elements">
    <div class="et_header-head align-center flex valign-center equal-columns">
        ...
        <div class="flex-right align-right">
            <span class="et_button templates et_edit" data-section="single_product_presets_content_separator">
                <span class="dashicons dashicons-schedule"></span>
