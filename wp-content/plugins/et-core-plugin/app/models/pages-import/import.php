...
class Etheme_Single_pages_Import {
    ...
    public function import_page_sliders(){
        ...
        if ( strpos( $slider_url, 'https://xstore.8theme.com/demos/2/' ) !== false ) {
            $slider_url = str_replace( 'https://xstore.8theme.com/demos/2/', 'http://8theme.com/import/xstore-versions/', $slider_url );
        } elseif( strpos( $slider_url, 'https://xstore.8theme.com/demos/' ) !== false ) {
            $slider_url = str_replace( 'https://xstore.8theme.com/demos/', 'http://8theme.com/import/xstore-versions/', $slider_url );
        } else {
            $slider_url = str_replace( 'https://xstore.8theme.com/', 'http://8theme.com/import/xstore-versions/', $slider_url );
        }
