...
class Special_Offer extends Shortcodes {
	...
	function offer_shortcode( $atts, $content ) {
		...
		$options['quick_view'] = function_exists('etheme_get_option') && etheme_get_option('quick_view');
		...
		$options['view'] = function_exists('etheme_get_option') ? etheme_get_option('product_view') : 'default';
		$options['view_color'] = function_exists('etheme_get_option') ? etheme_get_option('product_view_color') : 'dark';
