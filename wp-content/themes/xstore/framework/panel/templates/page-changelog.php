...
if( $check_update->is_update_available() ) {
	$out .= '<p class="et-message et-info">' . esc_html__('You are using the old theme version, please update to the latest one.', 'xstore') .
	        '<a href="'.admin_url('update-core.php').'" style="float: right;">'.esc_html__('Update Now', 'xstore').'</a>' .
	        '</p>';
}
