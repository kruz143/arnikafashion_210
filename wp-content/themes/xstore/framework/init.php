...
define( 'ETHEME_CORE_MIN_VERSION', '3.0.2' );
...
function etheme_customizer_css() { ?>
	<style>
		...
		@media only screen and (max-width: 1666px) {
			.wp-customizer:not(.rtl) .wp-full-overlay.expanded {
			    margin-left: 250px;
			}
            .wp-customizer.rtl .wp-full-overlay.expanded {
                margin-right: 250px;
            }
            .wp-customizer:not(.rtl) .wp-full-overlay.collapsed .wp-full-overlay-sidebar {
		        margin-left: -250px;
		    }
            .wp-customizer.rtl .wp-full-overlay.collapsed .wp-full-overlay-sidebar {
                margin-right: -250px;
            }
