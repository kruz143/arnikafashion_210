...
$show_excerpt = etheme_get_option('product_page_excerpt');
$excerpt_length = etheme_get_option('product_page_excerpt_length');
...
$with_quantity = etheme_get_option('product_page_smart_addtocart') && in_array('product_page_addtocart', $product_settings)
            && in_array( $view, array('default', 'mask3', 'mask', 'mask2') ) && $product_type == 'simple' && $product->is_in_stock();
